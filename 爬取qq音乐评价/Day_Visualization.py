...
#设置生成html文件
bar.render('K:\爬虫实例\爬取qq音乐评价\Day_Bar_Visualization.html')
...
c = (
    ...
    .render("K:\爬虫实例\爬取qq音乐评价\Day_Line_Visualization.html")
)
...
c = (
    ...
    .render("K:\爬虫实例\爬取qq音乐评价\Day_Line_smooth_Visualization.html")
)